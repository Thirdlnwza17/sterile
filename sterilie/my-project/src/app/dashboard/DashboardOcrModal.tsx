...
export default function DashboardOcrModal({ show, onClose, previewImage, ocrText, ocrLoading, saveLoading, saveSuccess, handleSaveOcrEntry, role }: {
  show: boolean,
  onClose: () => void,
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg relative max-h-[80vh] flex flex-col p-4">
        ...
        {role === 'admin' && (
          <div className="flex gap-2 mt-4">
            <button onClick={onClose} className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 rounded transition-all">ยกเลิก</button>
